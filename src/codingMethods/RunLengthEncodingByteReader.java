...
import FlexibleEncoding.ORC.RunLengthByteReader;
...
public class RunLengthEncodingByteReader    implements Decoder {
  ...
  //  //int  count=0 ;
  //  byte[] results=new byte[fileLong];
  //  for(int i=0; i < fileLong; ++i) {
  //
  //    results[i]= (byte) in.next();
  //    count ++ ;
  //  }
  //  inBuf.clear();
   ...
   */
  public   RunLengthEncodingByteReader(int sortedCol, int valueLen_,Algorithm  algorithm) {
    valueLen = valueLen_;
