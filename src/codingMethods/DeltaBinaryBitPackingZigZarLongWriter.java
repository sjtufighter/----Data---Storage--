...
public class DeltaBinaryBitPackingZigZarLongWriter extends Encoder{
...
//  public int startPos;
   ...
   * @see Algorithm
   */
  public DeltaBinaryBitPackingZigZarLongWriter(int pageLen_, int valueLen_, int startPos_, Algorithm algorithm) {
