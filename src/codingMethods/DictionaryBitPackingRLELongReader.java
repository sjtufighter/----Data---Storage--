...
public class DictionaryBitPackingRLELongReader implements Decoder {

  public DictionaryBitPackingRLELongReader(int sortedCol_, int valueLen_, Algorithm algorithm) {
