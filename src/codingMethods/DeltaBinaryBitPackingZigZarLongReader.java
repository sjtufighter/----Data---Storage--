...
public class DeltaBinaryBitPackingZigZarLongReader  implements  Decoder{

  public DeltaBinaryBitPackingZigZarLongReader(int sortedCol_, int valueLen_,  Algorithm algorithm) {
