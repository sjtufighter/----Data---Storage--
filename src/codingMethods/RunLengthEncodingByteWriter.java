...
public class RunLengthEncodingByteWriter extends  Encoder{
   ...
   * @see Algorithm
   */
  public RunLengthEncodingByteWriter(int pageLen_, int valueLen_, int startPos_, Algorithm algorithm) {
