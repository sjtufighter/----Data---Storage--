...
/**
 * A Fixed-length encoder to encode several cluster or triples in a page.
 */
public class FixedLenEncoder   extends  Encoder {
...
//  public int startPos;
   ...
   * @see Algorithm
   */
  public FixedLenEncoder(int pageLen_, int valueLen_, int startPos_, Algorithm algorithm) {
