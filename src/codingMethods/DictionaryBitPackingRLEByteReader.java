...
public class DictionaryBitPackingRLEByteReader implements Decoder {
   ...
   */
  public   DictionaryBitPackingRLEByteReader(int sortedCol, int valueLen_, Algorithm algorithm) {
    valueLen = valueLen_;
  ...
  public byte[]  CompressensureDecompressed() throws IOException {
    ...
    dib.close();
    DictionaryValuesReader cr = initDicReader(OnlydictionarySize,dictionaryBuffer,PrimitiveType.PrimitiveTypeName.BINARY);
