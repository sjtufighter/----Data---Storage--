...
public class DeltaBinaryBitPackingZigZarIntWriter extends Encoder{
   ...
   * @see Algorithm
   */
  public DeltaBinaryBitPackingZigZarIntWriter(int pageLen_, int valueLen_, int startPos_, Algorithm algorithm) {
