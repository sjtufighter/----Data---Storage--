...
public class DictionaryBitPackingRLEIntWriter  extends  Encoder{
   ...
   * @see Algorithm
   */
  public DictionaryBitPackingRLEIntWriter(int pageLen_, int valueLen_, int startPos_, Algorithm algorithm) {
