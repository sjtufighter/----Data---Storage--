...
import FlexibleEncoding.ORC.RunLengthIntegerWriterV2.EncodingType;

//import ORC.RunLengthIntegerWriterV2.EncodingType;
...
public   RunLengthIntegerReaderV2(InStream input, boolean signed) throws IOException {
    this.input = input;
    this.signed = signed;
  }
  ...
  public  void readDeltaValues(int firstByte) throws IOException {
  ...
  public void readPatchedBaseValues(int firstByte) throws IOException {
  ...
  public  void readDirectValues(int firstByte) throws IOException {
  ...
  public void readShortRepeatValues(int firstByte) throws IOException {
