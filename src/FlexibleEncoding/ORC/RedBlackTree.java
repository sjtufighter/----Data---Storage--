...
public abstract class RedBlackTree {
   ...
   */
  public  int insert(int left, int right, boolean isRed) {
    int position = size;
    size += 1;
   ...
   */
  public abstract int compareValue(int position);
   ...
   */
  public  void setRed(int position, boolean isRed) {
   ...
   */
  public void setLeft(int position, int left) {
    int offset = position * ELEMENT_SIZE + LEFT_OFFSET;
   ...
   * Note that we are storing the node color in the low bit of the left pointer.
   */
  public void setLeft(int position, int left, boolean isRed) {
    int offset = position * ELEMENT_SIZE + LEFT_OFFSET;
   ...
   */
  public void setRight(int position, int right) {
   ...
   */
  public  boolean add(int node, boolean fromLeft, int parent,
